...
const newUni = graduates.map(function(currentValue) {
  return universities.push(currentValue.university)
})
...
*/
const populationTotal = zooAnimals.reduce(function(accumulator, currentPopulation){
  return accumulator + currentPopulation.population;
}, 0);
